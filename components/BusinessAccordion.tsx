          ...
          >
            ...
            {open && (
              ...
              >
                ...
                <div
                  className="dm-blob mx-auto flex aspect-square w-full max-w-[280px] flex-col items-center justify-center p-[clamp(26px,3vw,40px)] text-center"
                  style={{ background: "rgba(245,241,232,0.07)" }}
                >
                  <p className="m-0 mb-2.5 text-[clamp(28px,3.4vw,44px)] font-extrabold leading-none tracking-[-0.03em] text-gold">
                    {b.stat}
                  </p>
                  <p className="m-0 mb-3.5 max-w-[14em] text-[14px] leading-[1.55] text-cream/82">{b.statLabel}</p>
                  <p className="m-0 text-[10.5px] font-bold tracking-[0.14em] text-progress">
                    [ PHOTO &mdash; {b.photo} ]
                  </p>
                </div>
              </div>
