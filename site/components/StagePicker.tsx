    ...
    <div>
      ...
      >
        ...
        <div
          ...
          style={s.img ? undefined : { background: "radial-gradient(circle at 32% 28%, #0B4B3D, #043028)" }}
        >
          {s.img && (
            <>
              <Image src={s.img} alt={`${s.name} — ${s.photo}`} fill sizes="380px" className="object-cover" />
